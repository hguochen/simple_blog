<?php
	class ImageHandler {
		...
		*/
		...
		/**
		 * Determines how to process iamges
		 * 
		 * Uses the MIME type of the provided image to determine what image handling functions should be
		 * used. This increases the performance of the script versus using imagecreatefromstring().
		 * 
		 * @param string $img the path to the upload
